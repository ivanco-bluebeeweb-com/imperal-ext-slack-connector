...
_LOCAL = ("app", "models", "slack_client", "slack_objects", "accounts",
          "shared", "inbound", "journal", "handlers_directory",
          "handlers_messages", "handlers_post", "handlers_admin",
          "handlers_inbound", "handlers_events", "handlers_journal",
          "panels")
for _mod in _LOCAL:
...
import handlers_journal  # noqa: E402,F401
